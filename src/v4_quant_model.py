...
class QuantGPT(nn.Module):
    def __init__(self, config: Config, layer=[1]) -> None:
        super().__init__()
            ...
            if input_pairs is None:
                ...
                for i in layer:
                    if i != layer[-1]:
                        ...
                        x, loss, *_ = self.transformer.h[i-1](x, (cos, sin), max_seq_length, input_pairs=input_pairs, target_pairs=target_pairs)
